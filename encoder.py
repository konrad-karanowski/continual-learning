...
import utils
# from pointnet_classifier import NakedPointNetClassifier, PointNet
from pointnet_classifier import PointNetClassificationModel, PointNetRepresentationModel
from pointnet_loss import pointnetloss
...
class Classifier(ContinualLearner, Replayer, ExemplarHandler):
    ...
    def __init__(self, sampling, channels, classes,
        ...
        # self.fcE = PointNet(sampling, 1024, fc_bn)
        self.fcE = PointNetRepresentationModel(z_size=Z_SIZE)

        # classifier
        # self.classifier = NakedPointNetClassifier(1024, fc_bn, classes)
        self.classifier = PointNetClassificationModel(classes, z_size=Z_SIZE, dropout=0.3, pointnet=self.fcE)
    ...
    def train_a_batch(self, x, y, scores=None, x_=None, y_=None, scores_=None, rnt=0.5, active_classes=None, task=1):
        ...
        if x is not None:
            ...
            if self.binaryCE:
                ...
                predL = None if y is None else pointnetloss(
                    y_hat, y, a, b
                )
